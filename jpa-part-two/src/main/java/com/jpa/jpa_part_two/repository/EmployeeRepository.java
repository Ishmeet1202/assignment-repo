...
//@Modifying
//    @Query(value = "delete from employee_table e where e.age= :age ",nativeQuery = true)
//    void deleteAfterage(int age);
@Modifying
@Transactional
@Query(value = "DELETE FROM employee_table WHERE emp_age > :age",
       nativeQuery = true)
